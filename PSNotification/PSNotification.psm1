...
if ($PSNotification_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName PSNotification.Import.IndividualFiles -Fallback $false
if ($PSNotification_importIndividualFiles) { $importIndividualFiles = $true }
